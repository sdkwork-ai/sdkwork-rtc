# Runbook — sdkwork-rtc deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-rtc-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-rtc/bundle`, loads the image, starts
